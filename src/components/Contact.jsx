              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-white text-lg leading-relaxed">
                    ...
                    about tech, I’m all ears! Drop me a message, and let’s make
                    it happen.
                  </p>
                </div>
                ...
                <div className="bg-cyan-50/10 backdrop-blur-sm p-8 rounded-xl shadow-lg">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full px-6 py-3 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 transition-colors duration-300 font-medium shadow-sm shadow-cyan-500/10 hover:shadow-cyan-500/50"
                    >
